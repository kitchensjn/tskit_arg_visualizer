...
arg_json = json.load(open("/Users/jameskitchens/Downloads/tskit_arg_visualizer.json", "r"))
x_pos = viz.extract_x_positions_from_json(arg_json)
...
d3arg.nodes["size"] = 400
d3arg.nodes["stroke_width"] = 4
